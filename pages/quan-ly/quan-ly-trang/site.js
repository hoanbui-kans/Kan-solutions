...
import { BlogContent } from '../quan-ly-trang';
...
const SiteEditor = ({site_content}) => {
  ...
  const [doimain, setDoimain] = useState(data.domain);
  console.log(data);
    ...
    <>
                        ...
                        <div className={styles.x_blog}>
                            <Row>
                                <Col xs={24}>
                                    ...
                                    <div className={styles.x_change_doimain}>
                                      <Form 
                                        fluid
                                      >
                                        <Form.Group>
                                          ...
                                          <Form.Control name="doimain" type="text" defaultValue={doimain} onChange={(e) => {setDoimain(e)}} />
                                        </Form.Group>
                                        <Form.Group>
      ...
      <Modal open={openReplaced} onClose={handleCloseReplaced} backdrop="static">
        ...
        <Modal.Body>
          ...
          <div className={styles.x_board_doimain_change}>
              <span className={styles.x_current_doimain}>
                  { data.domain }
              </span>
              <span className={styles.x_doimain_change_arrow}>
                <IoArrowForwardSharp />
              </span>
              <span className={styles.x_replaced_doimain}>
                  { doimain }
              </span>
          </div>
          ...
          <Button type="submit" className={styles.x_change_doimain_button}>
